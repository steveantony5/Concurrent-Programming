...
int main(int argc, char *argv[])
{
    ...
    if(argv[1]== NULL)
    {
        ...
        printf("./mysort [Sourcefilename] -t[no of threads] -algs=<bucket,fj> [--lock=<tas,ttas,ticket,mcs,pthread>] -o [outputfilename]\nSource filename mandatory\n");
        exit(1);
    }
    ...
    while ((c = getopt_long (argc, argv, "n:o:t:a:l:", long_options, 0)) != -1)
    {
        switch (c)
        {
            case 'n':
